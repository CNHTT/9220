...
import com.szfp.retrofit.interfaces.Progress;
import com.szfp.retrofit.interfaces.Success;
import com.szfp.retrofit.interfaces.Error;
import com.szfp.retrofit.utils.NetUtils;
import com.szfp.retrofit.utils.WriteFileUtil;
...
import static com.szfp.retrofit.HttpUtil.checkHeaders;
import static com.szfp.retrofit.HttpUtil.checkParams;
import static com.szfp.retrofit.HttpUtil.putCall;
...
public class HttpBuilder {
    ...
    public void postBady(){
        if (!allready()) {
            return;
        }
        Call call = HttpUtil.getService().postBody(checkUrl(this.url),body ,checkHeaders(headers));
        putCall(tag, url, call);
        call.enqueue(new Callback<String>() {
            @Override
            public void onResponse(Call<String> call, Response<String> response) {
