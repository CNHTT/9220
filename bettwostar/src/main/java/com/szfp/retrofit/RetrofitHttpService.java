...
public interface RetrofitHttpService {
    ...
    @Headers({"Content-Type:application/json;charset=UTF-8"})//请求的Action，类似于方法名
    @POST()
    Call<String> postBody(@Url String url, @Body String body ,@HeaderMap Map<String, String> headers);
