...
import com.odd.sportal.InsertNewBetActivity;
...
public class EventLiveModelAdapter extends BaseListAdapter<EventLiveModel> {

    private OnEventLiveAdapterListener listener;

    public EventLiveModelAdapter(Context mContext, List<EventLiveModel> mDatas, OnEventLiveAdapterListener listener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EventLiveModel bean = getItem(position);
        ...
        viewHolder.llBetView.setOnClickListener( v ->{
            listener.getEventLiveBean(bean);
        });
