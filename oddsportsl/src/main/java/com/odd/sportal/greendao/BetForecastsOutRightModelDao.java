...
/** 
 * DAO for table "BET_FORECASTS_OUT_RIGHT_MODEL".
*/
public class BetForecastsOutRightModelDao extends AbstractDao<BetForecastsOutRightModel, Long> {

    public static final String TABLENAME = "BET_FORECASTS_OUT_RIGHT_MODEL";

    /**
     * Properties of entity BetForecastsOutRightModel.<br/>
    ...
    public BetForecastsOutRightModelDao(DaoConfig config) {
        super(config);
    }
    
    public BetForecastsOutRightModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BET_FORECASTS_OUT_RIGHT_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BET_FORECASTS_OUT_RIGHT_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BetForecastsOutRightModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, BetForecastsOutRightModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public BetForecastsOutRightModel readEntity(Cursor cursor, int offset) {
        BetForecastsOutRightModel entity = new BetForecastsOutRightModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, BetForecastsOutRightModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(BetForecastsOutRightModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BetForecastsOutRightModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BetForecastsOutRightModel entity) {
