...
/** 
 * DAO for table "GAME_MODEL".
*/
public class GameModelDao extends AbstractDao<GameModel, Long> {

    public static final String TABLENAME = "GAME_MODEL";

    /**
     * Properties of entity GameModel.<br/>
    ...
    public GameModelDao(DaoConfig config) {
        super(config);
    }
    
    public GameModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GAME_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GAME_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GameModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GameModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public GameModel readEntity(Cursor cursor, int offset) {
        GameModel entity = new GameModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, GameModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(GameModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GameModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GameModel entity) {
