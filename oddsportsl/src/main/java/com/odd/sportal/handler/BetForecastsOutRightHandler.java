...
public class BetForecastsOutRightHandler extends BaseHandler {

    CallBackSuccess callBackSuccess;
    public BetForecastsOutRightHandler(CallBackSuccess callBackSuccess) {
    ...
    BetForecastsOutRightModel object;
    @Override
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {

        try {
            if(qName.equals("ROW")){
                object = new BetForecastsOutRightModel();
                ...
                DbHelper.insertNewBetForecastsOutRight(object);
