...
import com.odd.sportal.model.EvtPreGameModel;
...
/**
 * Created by 戴尔 on 2017/12/15.
 */

public class EvtPreGameModelHandler extends BaseHandler {
    @Override
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        try {
            if (qName.equals("ROW")){
                EvtPreGameModel object = new EvtPreGameModel();
                ...
                object.setDISPLAY_ORDER(DataUtils.getNumberLong("DISPLAY_ORDER",attributes));
