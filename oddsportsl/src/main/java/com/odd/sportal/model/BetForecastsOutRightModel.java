 ...
 */
@Entity
public class BetForecastsOutRightModel  implements Serializable {
        ...
        @Generated(hash = 1513928985)
        public BetForecastsOutRightModel(Long id, long ID, long EVENT_ID, long GAME_ID,
        ...
        @Generated(hash = 2051863312)
        public BetForecastsOutRightModel() {
        }
        public Long getId() {
            return this.id;
        }
